...
function SEOMeta() {
  useEffect(() => {
      ...
      "@graph": [
        {
          ...
          "name": "INTSIG IDP — Intelligent Document Processing",
          "applicationCategory": "BusinessApplication",
          "operatingSystem": "Web, Cloud, On-Premise",
          "description": "AI-powered intelligent document processing platform with 99%+ OCR accuracy across 50+ languages. Automates invoices, KYC, contracts, and enterprise document workflows.",
          "offers": { "@type": "Offer", "availability": "https://schema.org/InStock", "seller": { "@type": "Organization", "name": "TechBee IT & Designs LLC" } },
          "featureList": ["OCR AI", "Document Classification", "Invoice Automation", "KYC Processing", "SAP Integration", "Arabic Language Support"],
        },
        {
          "@type": "LocalBusiness",
          "name": "TechBee IT & Designs LLC",
          "description": "Authorised INTSIG IDP partner for UAE and GCC. AI document processing, intelligent automation, and enterprise software solutions.",
          "url": "https://www.techbee.ae",
          "telephone": "+97142434882",
          "email": "sales@techbee.ae",
          "address": { "@type": "PostalAddress", "streetAddress": "R-12, France Cluster, International City", "addressLocality": "Dubai", "addressCountry": "AE" },
          "areaServed": ["AE", "SA", "QA", "KW", "BH", "OM"],
          "sameAs": ["https://www.techbee.ae"],
        },
        {
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "What is Intelligent Document Processing?", "acceptedAnswer": { "@type": "Answer", "text": "IDP uses AI, OCR, and NLP to automatically read, extract, classify, and route data from any document type — replacing manual data entry with 99%+ accuracy." } },
            { "@type": "Question", "name": "Does INTSIG IDP support Arabic documents?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. INTSIG's OCR engine supports 50+ languages including Arabic with 99%+ accuracy — essential for UAE and GCC government and enterprise document workflows." } },
            { "@type": "Question", "name": "Which ERP systems does IDP integrate with?", "acceptedAnswer": { "@type": "Answer", "text": "IDP integrates with SAP, Oracle, Microsoft Dynamics 365, NetSuite, QuickBooks, Xero, Salesforce, SharePoint, and any system via REST API." } },
          ],
        },
      ],
    }
    ...
    return () => {
      document.title = "TechBee IT & Designs LLC"
    }
  }, [])
      ...
      >
        ...
        <section style={{ background: "#000", borderTop: "1px solid #111", borderBottom: "1px solid #111", padding: "32px 60px" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            <p style={{ color: "#555", fontSize: 13, margin: 0 }}>
              Authorised INTSIG IDP Partner · UAE & GCC
            </p>
            <div style={{ display: "flex", gap: 32, flexWrap: "wrap", alignItems: "center" }}>
              {[
                { val: "2.3B+", label: "Global Users" },
                { val: "200+",  label: "Countries" },
                { val: "200+",  label: "Patents" },
                { val: "SHSE: 688615", label: "Listed" },
              ].map((s, i) => (
        ...
        <section className="py-[96px] px-6" style={{ background: "#000" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            {/* About INTSIG callout — Image LEFT · text RIGHT */}
            <div style={{
              display: "flex",
              flexWrap: "wrap",
              alignItems: "center",
              ...
              <div style={{ flex: "0 0 44%", minWidth: 280, lineHeight: 0 }}>
                <img
                  ...
                  alt="INTSIG — AI-powered long-term client collaboration and document intelligence platform"
                  style={{
                    width: "100%",
                    display: "block",
                    objectFit: "cover",
        ...
        <section className="py-[96px] px-6" style={{ background: "#000" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <FAQItem q="How long does implementation take?"
            ...
            <FAQItem q="What document formats does IDP support?"
            ...
            <FAQItem q="Can IDP handle Arabic and other RTL languages?"
            ...
            <FAQItem q="Is my data secure? Who can see my documents?"
            ...
            <FAQItem q="What happens when the AI is uncertain about an extraction?"
