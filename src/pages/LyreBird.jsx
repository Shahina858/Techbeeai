        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 32 }}>
            ...
            <div style={{ background: "#0f0f0f", border: "2px solid #f5b800", borderRadius: 14, padding: "28px 22px", display: "flex", flexDirection: "column", position: "relative" }}>
              ...
              <div style={{ marginBottom: 20 }}><span style={{ color: "#f5b800", fontSize: "2rem", fontWeight: 800 }}>$52.5</span><span style={{ color: "#555", fontSize: 13, marginLeft: 6 }}>per user / year (billed annually)</span></div>
