...
const WHY_ITEMS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 8a4 4 0 100 8 4 4 0 000-8z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 2.75V5.5M12 18.5V21.25M5.5 5.5L7.25 7.25M16.75 16.75L18.5 18.5M2.75 12H5.5M18.5 12H21.25M5.5 18.5L7.25 16.75M16.75 7.25L18.5 5.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    title: "AI Innovation",
    desc: "Continuously retrained models built on latest AI Research",
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 16.5L10.5 11l3 3 5.5-5.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5 20H18" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
    title: "Scalable Architecture",
    desc: "From 50 to 50,000 users — no re-platforming needed",
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 3l7 4v5.5c0 3.25-2.25 6-5.5 6.75a7.25 7.25 0 01-5.5-1.25C6.25 18.5 4 15.75 4 12.5V7l8-4z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M7 7h10M7 11h6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path d="M5 19l2-4h10l2 4-6-3-6 3z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    title: "Dedicated Support",
    desc: "Onboarding, CSM, and SLA-backed technical assistance",
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M4.75 12h14.5M12 4.75v14.5M7.25 7.25c2 2 4.5 2 6.5 0M16.75 16.75c-2-2-4.5-2-6.5 0" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
    title: "Global & Multilingual",
    desc: "50+ languages · region-specific customization",
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="5" y="5" width="5" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.8" />
        <rect x="14" y="5" width="5" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.8" />
        <rect x="5" y="14" width="5" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.8" />
        <rect x="14" y="14" width="5" height="5" rx="1.5" stroke="currentColor" strokeWidth="1.8" />
      </svg>
    ),
    title: "Seamless Integrations",
    desc: "Salesforce, SAP, EMR, HubSpot, Zendesk & 100+ more",
