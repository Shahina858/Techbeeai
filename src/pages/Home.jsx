...
{ route: "/camcard", icon: <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="9" fill="#f5b800"/><text x="50%" y="54%" dominantBaseline="middle" textAnchor="middle" fill="#000" fontSize="16" fontWeight="800" fontFamily="Arial, sans-serif">CC</text></svg>, title: "AI Powered Contact Management", subtitle: "Smart Contact Solutions", desc: "Digitize and manage business cards effortlessly using intelligent OCR and data extraction. CamCard AI helps you organize contacts, eliminate manual entry, and streamline networking." },
