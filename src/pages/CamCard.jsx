...
// ── Steps data ─────────────────────────────────────────────────────────────────
const STEPS = [
  { n: "01", label: "Scan", title: "Point camera at any business card", desc: "Works with any card — physical, digital, landscape, portrait. Any orientation, any language, any format.", icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7V5a2 2 0 0 1 2-2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M21 17v2a2 2 0 0 1-2 2h-2"/><path d="M7 21H5a2 2 0 0 1-2-2v-2"/><rect x="7" y="7" width="10" height="10" rx="1"/></svg> },
  { n: "02", label: "Extract", title: "AI reads every detail in 2 seconds", desc: "Name, title, company, email, phone, social handles — extracted instantly with 99.9% accuracy across 40+ languages.", icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg> },
  { n: "03", label: "Sync", title: "Contact flows to CRM & address book", desc: "Automatically pushed to Salesforce, HubSpot, Zoho, or your address book — zero manual entry, zero lost leads.", icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="1 4 1 10 7 10"/><polyline points="23 20 23 14 17 14"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4-4.64 4.36A9 9 0 0 1 3.51 15"/></svg> },
]

const FEATURES = [
  "Instant AI card scanning in any language", "CRM auto-sync (Salesforce, HubSpot, Zoho)",
  "Smart deduplication & contact enrichment", "Team contact sharing with access controls",
  "LinkedIn & social profile auto-append", "40+ language OCR support",
  "Offline scanning — syncs when connected", "Bulk card scanning mode", "Export to Excel / CSV / vCard",
]
...
const USE_CASES = [
  { role: "Sales Teams", title: "Scan. Sync. Close deals faster at every event and trade show.", desc: "Sales reps scan hundreds of cards at conferences. CamCard AI extracts every detail and pushes contacts directly into Salesforce or HubSpot — no manual entry, no lost leads.", tags: ["Trade Shows", "Salesforce Sync", "Zero Manual Entry"], icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> },
  { role: "Executive Assistants", title: "Manage contacts for the entire leadership team.", desc: "Digitize, organize, and share executive contacts across the team with role-based access — always in sync.", tags: ["Role-based Access", "Team Sharing", "Always in Sync"], icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
  { role: "Field Sales", title: "On-the-go scanning. Works offline, syncs when connected.", desc: "No internet? No problem. CamCard AI scans and stores locally — syncing everything to your CRM the moment you're back online.", tags: ["Offline Mode", "Auto Sync", "Mobile-First"], icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> },
  { role: "HR & Recruitment", title: "Turn job fair contacts into qualified candidates instantly.", desc: "Recruiters scan candidate cards at hiring events and CamCard AI syncs every detail directly into their ATS or CRM — so no promising candidate ever slips through the cracks.", tags: ["ATS Integration", "Hiring Events", "Candidate Tracking"], icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg> },
  { role: "Healthcare & Medical", title: "Referral contacts organized instantly.", desc: "Specialists scan referral cards at conferences. Contacts sync to CRM automatically — specialists, conferences, referrals, all tracked and maintained.", tags: ["Specialists", "Conferences", "Referrals", "Sync to CRM"], icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5b800" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> },
]
    ...
    <div className="bg-black text-white overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="relative w-full" style={{ zIndex: 10, maxWidth: 1300, margin: "0 auto", padding: "140px 64px 80px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          ...
          <div style={{ flex: "0 0 52%", maxWidth: 640 }}>
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}
              ...
              {/* Watch Demo — visual only, no redirect */}
              <button
          ...
          <motion.div initial={{ opacity: 0, x: 48 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.25 }}
            ...
            <div style={{ width: "clamp(260px, 34vw, 460px)", aspectRatio: "1 / 1", borderRadius: 32, overflow: "hidden", boxShadow: "0 0 80px rgba(0,180,255,0.4), 0 0 160px rgba(0,180,255,0.18), 0 40px 80px rgba(0,0,0,0.7)", border: "1px solid rgba(0,200,255,0.25)" }}>
              <img src={CARD_IMG} alt="CamCard AI" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }}/>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-[100px] px-6" style={{ background: "#0a0a0a" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ textAlign: "center", fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: "#ffffff", marginBottom: 8, letterSpacing: "-0.01em" }}>How CamCard AI Powers</h2>
