...
function ValueCard({ icon, title, desc }) {
  return (
    ...
    >
      ...
      <p style={{ color: "#b4b4b4", fontSize: 14, lineHeight: 1.7, margin: 0 }}>{desc}</p>
    </motion.div>
  )
}
...
function StatBlock({ value, label }) {
  return (
    <div style={{ textAlign: "center", padding: "28px 20px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(245,184,0,0.2)", borderRadius: 14, position: "relative", overflow: "hidden" }}>
      ...
      <p style={{ color: "#aeacac", fontSize: 13, lineHeight: 1.6, margin: 0, position: "relative" }}>{label}</p>
    </div>
  )
}
...
export default function AboutUs() {
  ...
  const timeline = [
    { year: "2017", text: "Founded in Dubai, United Arab Emirates" },
    { year: "2020", text: "Became an AV Specialist" },
    { year: "2021", text: "Became an OCR Solution Partner" },
    { year: "2023", text: "Became an IDP Partner" },
    { year: "2024", text: "Call Center Solutions — Tegsoft AI Contact Center" },
    { year: "2025", text: "IntSig Partner — CamCard Contact Management" },
    { year: "2026", text: "Lyrebird AI Medical Scribe & Webishopi B2B Platform" },
  ]
  ...
  return (
    <div style={{ background: "#000", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
      ...
      {/* ── HERO ── */}
      <section style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "linear-gradient(135deg, #000 0%, #0a0a0a 60%, #0d0d0d 100%)" }}>
        <div style={{ position: "absolute", inset: 0, zIndex: 0, backgroundImage: "url('/Frame_186_jpg.jpeg')", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.28, filter: "saturate(0.6)" }} />
        <div style={{ position: "absolute", inset: 0, zIndex: 0, background: "linear-gradient(to bottom, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.85) 60%, #000 100%)" }} />
        <div style={{ position: "absolute", inset: 0, zIndex: 0, backgroundImage: "radial-gradient(rgba(245,184,0,0.04) 1px, transparent 1px)", backgroundSize: "28px 28px", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: 760, textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}
            style={{ color: "#c3c3c3", fontSize: "clamp(0.95rem, 1.4vw, 1.1rem)", lineHeight: 1.8, maxWidth: 620, margin: "0 auto 36px" }}>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}
            ...
            <a href="https://techbee.ae" target="_blank" rel="noopener noreferrer"
      ...
      <section style={{ padding: "80px 24px", background: "#000" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            <StatBlock value="8+"   label="Years delivering technology solutions" />
      ...
      <section style={{ padding: "96px 24px", background: "#0a0a0a" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "#939393", fontSize: 15, lineHeight: 1.85, marginBottom: 18 }}>
              Founded in Dubai in 2017, TechBee IT & Designs LLC started as a trusted IT infrastructure and AV specialist for businesses across the UAE. Over the years we expanded into OCR solutions, IDP partnerships, and AI-powered contact center technology.
            </p>
            <p style={{ color: "#929292", fontSize: 15, lineHeight: 1.85, marginBottom: 18 }}>
              Today, TechBee AI represents our leap into the next era — building and reselling AI-powered products that automate workflows, reduce operational costs, and unlock new revenue for our clients. From AI medical scribes to smart B2B platforms, we bring world-class technology to the GCC market.
            </p>
            <p style={{ color: "#929292", fontSize: 15, lineHeight: 1.85 }}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ background: "#0f0f0f", border: "1px solid rgba(245,184,0,0.18)", borderRadius: 18, padding: "36px 32px", display: "flex", flexDirection: "column", gap: 0 }}>
              {timeline.map((item, i) => {
                ...
                return (
                  <div key={i} style={{ display: "flex", gap: 0, alignItems: "stretch" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 56, flexShrink: 0 }}>
                      <div style={{
                        background: is2026 ? "rgba(245,184,0,0.2)" : "rgba(245,184,0,0.1)",
                        border: `1px solid ${is2026 ? "rgba(245,184,0,0.6)" : "rgba(245,184,0,0.3)"}`,
                        borderRadius: 8, padding: "4px 0", width: 50, textAlign: "center", flexShrink: 0,
                        boxShadow: is2026 ? "0 0 12px rgba(245,184,0,0.25)" : "none",
                      }}>
                        <span style={{ color: "#f5b800", fontSize: 12, fontWeight: 800 }}>{item.year}</span>
                      </div>
                      {!isLast && (
                        <div style={{ width: 1, flex: 1, background: "rgba(245,184,0,0.15)", margin: "4px 0" }} />
                      )}
                    </div>
                    {/* Right: text */}
                    <div style={{ paddingLeft: 16, paddingBottom: isLast ? 0 : 20, paddingTop: 4, flex: 1 }}>
                      <p style={{ color: "#999", fontSize: 14, lineHeight: 1.6, margin: 0, fontWeight: 400 }}>
                        {item.text}
                        {is2026 && (
                          <span style={{ marginLeft: 8, background: "rgba(245,184,0,0.15)", border: "1px solid rgba(245,184,0,0.3)", borderRadius: 20, padding: "1px 8px", fontSize: 10, fontWeight: 700, letterSpacing: "0.06em", verticalAlign: "middle" }}>
                            NEW
                          </span>
                        )}
                      </p>
      ...
      <section style={{ padding: "96px 24px", background: "#000" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: "#9e9e9e", fontSize: 16, lineHeight: 1.7, marginBottom: 40 }}>
